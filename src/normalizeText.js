//
// This snippet is original from https://github.com/react-native-training/react-native-elements/blob/master/src/helpers/normalizeText.js
...
export const normalize = (size: number, deviceHeight: number, deviceWidth: number, pixelRatio: number) => {
  if (pixelRatio === 2) {
